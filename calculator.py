...
class Calculator:
    ...
    def create_equal_button(self):
        button = tk.Button(self.buttons_frame, text='=', bg=VALENTINE, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE, borderwidth=0, command=self.evaluate)
